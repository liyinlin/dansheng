    ...
    return {
        ...
        load: function(){
            ...
            if($('#wxjscfg').length == 0){
                ...
                loadJS("wxjscfg", "http://www.hunliji.com/p/wedding/index.php/Shop/Wechat/jsticket/0/" + wxShare.Encode64(url) + "/cfg.js");
            }
        },
        ...
        setWeiXinData: function (args) {
            ...
            function SetWeixinShare(wxready, invready) {
                ...
                wx.onMenuShareTimeline({
                    title: config['timelineTitle'], link: _link, imgUrl: _img, success: function () {
                    }, cancel: function () {
                    }
                });
